  ...
  return (
    <header className="sticky top-0 z-30 bg-pine-950/95 backdrop-blur border-b border-pine-700">
      <div className="max-w-6xl mx-auto px-3 py-2 flex flex-col gap-2">
        ...
        {/* Linha 2: Barra de pesquisa -- ocupa a largura toda */}
        <div className="flex items-center bg-pine-800 border border-pine-600 rounded-full px-3 py-1.5 gap-2">
