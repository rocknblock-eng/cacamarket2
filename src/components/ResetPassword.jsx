...
export default function ResetPassword() {
  ...
  return (
    <div className="min-h-screen bg-pine-950 flex items-center justify-center p-4">
      <div className="bg-pine-800 border border-pine-600 rounded-2xl w-full max-w-sm p-6">
        ...
        {success ? (
          <div className="text-center">
            ...
            <a href="/" className="text-xs text-blaze-400 hover:underline">
              Clica aqui se não fores redirecionado
            </a>
          </div>
        ) : !validSession ? (
          <div className="text-center">
            <p className="text-bone-300/70 text-sm">A verificar o link de recuperação…</p>
            <p className="text-bone-300/50 text-xs mt-2">
